	...
	return (
		<div className="header-page">
			...
			<nav className="header-nav">
				<li className="header-logo-home-container">
					<img className="header-logo-home" src={home} alt="Accueil" />
					<p>Accueil</p>
				</li>
				<li className="header-logo-about-container">
					<img className="header-logo-about" src={about} alt="À propos" />
					<p>A propos</p>
				</li>
				<li className="header-logo-projects-container">
					<img className="header-logo-projects" src={projects} alt="Projets" />
					<p>Projets</p>
				</li>
				<li className="header-logo-contact-container">
